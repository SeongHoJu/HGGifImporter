...
namespace GifConverter
{
    public class Converter
    {
        ...
        [DllExport("DecodeGifToFrame", CallingConvention = CallingConvention.StdCall)]
        static public unsafe int DecodeGifToFrame(IntPtr UE4GifBinaries, int UE4GifBinaryLength, RequestBinaryImageAlloc RequestAllocFunction)
        {
